...
After finishing this course, my view is that as a developer it should be mandatory to have atleast some kind of general knowledge about how to protect an application before you actually start working on any kind of real life application. 
